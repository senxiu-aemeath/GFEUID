"""武器 Wiki 图片渲染 — Playwright 截图 gf2.mcc.wiki"""
...
async def draw_weapon_wiki(slug: str, name: str) -> str | None:
    """返回武器 Wiki 图片的 base64 字符串"""
    ...
    cache_file = WIKI_CACHE_PATH / f"weapon_{slug}.png"
    ...
    try:
        ...
        await page.goto(f"{WIKI_BASE}/weapon/{slug}", wait_until="networkidle", timeout=30000)
